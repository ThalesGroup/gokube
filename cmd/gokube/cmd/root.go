...
const (
	DEFAULT_KUBERNETES_VERSION         = "v1.33.1"
	DEFAULT_KUBECTL_VERSION            = "v1.33.1"
	DEFAULT_MINIKUBE_VERSION           = "v1.36.0"
	...
	DEFAULT_DOCKER_VERSION             = "28.3.1"
	DEFAULT_HELM_VERSION               = "v3.18.3"
